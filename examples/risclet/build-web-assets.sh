...
for required_file in "$ROOT_DIR/splitimg" "$ROOT_DIR/build_filelist" \
...
mkdir -p "$OUTPUT_DIR/drive" "$OUTPUT_DIR/fs"
...
"$ROOT_DIR/build_filelist" "$SCRIPT_DIR/demo" "$OUTPUT_DIR/fs"
